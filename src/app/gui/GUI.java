...
public final class GUI extends ControlP5 
{
	...
	private Menu 	_menu;
	private Button 	_historyBackButtton;
	private Button 	_historyForwardButtton;
	...
	public GUI(PApplet canvas) 
	{
		...
		_historyBackButtton = this.addButton("Back")
			.setPosition(canvas.width - BUTTON_WIDTH, 0)
		   	.setSize(BUTTON_WIDTH, DEFAULT_HEIGHT)
		;
		
		_historyForwardButtton = this.addButton("Forward")
	...
	public Button getHistoryBackButton() { return _historyBackButtton; }
	public Button getHistoryForwardButton() { return _historyForwardButtton; }
	...
	public void setCallbackListener(CallbackListener menuCallbackListener) 
	{
		...
		_historyForwardButtton.onClick(menuCallbackListener);
		_historyBackButtton.onClick(menuCallbackListener);
